...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-full px-5 py-3 text-sm font-semibold transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-clay focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-goldenYellow text-ink hover:bg-chartreuse",
        dark: "bg-cobalt text-warmCream hover:bg-cobalt/90",
        outline: "border border-ink/20 bg-transparent text-ink hover:border-ink hover:bg-cobalt hover:text-warmCream",
        light: "bg-warmCream text-ink hover:bg-seafoam",
      },
      size: {
        default: "h-12",
